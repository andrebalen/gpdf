GPDF.controller('pdfCtrl',  function($rootScope, $scope, $cordovaFile, $cordovaNetwork, $cordovaToast, $cordovaFileTransfer, $cordovaCamera)
{
  ...
  document.addEventListener("deviceready", function ()
  {
    ...
    $scope.file = function(){
      ...
      var fileName = $scope.data.user+'_fbr_'+$scope.data.apelido+'_prod_'+$scope.data.tiprod+'_'+mili+'.pdf';
 ...
 // Função responsável por executar a captura dos dados e geração do PDF
  var geraPdf = function()
  {
    ...
    pdf.setProperties(
      ...
      author: 'Andre Balen - po@gmail.com',
    ...
    pdf.text(70, 10, ' fornecedor: ' + name);
    pdf.text(70, 20, ' cliente: '+ usuario);
