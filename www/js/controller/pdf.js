...
//    console.log("espaco livre é :"+ free);
    ...
    $scope.file = function()
    {
      ...
      var epoc = new Date().getTime(); // internamente chamamos o epoc de sourcingID
...
//    var tem3aimagemDeProduto = false;
    ...
    pdf.setProperties({
      ...
      keywords: 'draft, PO, guelcos, purchase order, china trade fair, trade fair app, canton fair',
 ...
 $scope.data.showPdf=function(filename)
{
